...
class ShipmentEventService(BaseService):
    ...
    async def get_latest_event(self, shipment: Shipment):
        ...
        # O argumento key recebe uma função que define qual atributo de cada item será usado para ordenar a lista.
        # ordena os eventos pela data e depois pega o ultimo.
